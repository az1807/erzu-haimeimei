...
<header>
            ...
            <div class="header-title div-inline">
             <%
               Company gongsi =  (Company)request.getAttribute("company");
                ...
                <strong><%=gongsi.getName()%></strong>
                <span>www.haimeimei.com</span>
            </div>
    ...
    <div class="header-nav">
        ...
        <ul class="header-nav-ul am-collapse am-in">
            ...
            <li><a href="Guanyuwmen" name="about">关于我们</a></li>
            <li><a href="ChanpinServlet" name="show">产品展示</a></li>
            <li><a href="XinwenServlet" name="new">新闻资讯</a></li>
            <li><a href="LianxiServlet" name="message">联系我们</a>
